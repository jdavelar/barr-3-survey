...
CURRENTLY IN PROCESS OF UPDATING - N DISTRICTS ARE NOT MATCHING RESPONDENTS
...
datatable(count_state,
          caption = "Table 6.6c Within each category (State policy factors)",
...
datatable(count_local,
          caption = "Table 6.6d Within each category (Local community factors)",
          colnames = c("Total factors selected", "Number of districts", "Helps", "Hinders"),
          rownames = FALSE,
          filter = 'top')
...
datatable(count_external,
          caption = "Table 6.6e Within each category (External factors)",
          colnames = c("Total factors selected", "Number of districts", "Helps", "Hinders"),
          rownames = FALSE,
          filter = 'top')
```
...
```{r, include = FALSE, eval = FALSE}
# Save table
write.csv(count_state, "output/tables/table_6.6c.csv", row.names = FALSE)
write.csv(count_local, "output/tables/table_6.6d.csv", row.names = FALSE)
write.csv(count_external, "output/tables/table_6.6e.csv", row.names = FALSE)
rm(count_external, count_local, count_state)
```
